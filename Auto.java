/*  Author: Carter Buckner
    project: Assignment4 - Auto Class
  ...
  public double drive(int distance, double xRatio, double yRatio){
    ...
    int milesDriven = 0;
      ...
      // true if a^2 + b^2 = c^2 and Law of Similar Triangles (xRatio/yRatio)=(xDistance/yDistance)
        double xDistance =  (double) (Math.sqrt((distance*distance)/(1+slope*slope))) ;
        ...
        setX(((int) ((double) (getX() + xDistance))));
        setY(((int) ((double) (getY() + yDistance))));
